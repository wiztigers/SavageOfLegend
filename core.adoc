...
1. Choix de la race
2. Choix des Traits +
   Le personnage obtient gratuitement une <<knowledges,Connaissance>> artisanale et artistique de son choix
...
* Certaines Compétences du système de base de _Savage Worlds_ peuvent être reprises en tant que Connaissances. Ce sont : _Conduite_ (d'attelages), _Jeu_, _Pistage_, _Natation_, _Navigation_.
...
* Une compétence artisanale et artistique est aussi une Connaissance.
  Quelques exemples : _Art du conteur_, _Broderie_, _Gravures runiques_, _Peinture_, _Sculpture sur bois_, _Tatouages_, ...
