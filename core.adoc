...
[role='race']
=== Humains
*Potentiel :* Un humain débute avec 3 <<build_your_legend,points de Légende>> supplémentaire.
...
*Bonne Figure* +*+: <<spell_boost_lower_trait,Augmentation de Trait>> (<<skill_persuasion,Persuasion>>, uniquement pour convaincre de son identité ou se comporter en fonction de son rôle) +
*Bourse Plate*: MOOT +
...
*Habillage* +*+: <<spell_boost_lower_trait,Augmentation de Trait>> (<<skill_persuasion,Persuasion>>, pour améliorer l'attitude) +
*Idée fixe* +*+: MOOT +
...
*Belles Manières* +*+: <<spell_boost_lower_trait,Augmentation de Trait>> (<<skill_persuasion,Persuasion>>, tant que le personnage se comporte en gars de la Haute) +
...
*Horreur Astrale:* +*+ MOOT (un *Fantôme de brume* qui attaque 2×) +
